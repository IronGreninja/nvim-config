...
vim.o.scrolloff      = 10         -- min no. of screen lines above & below the cursor
...
-- vim.o.fillchars = 'eob: ,fold:╌,foldclose:,foldopen:,foldsep:▕'
...
Config.new_autocmd(
  ...
  "`:h` help opens in vertical split"
)
...
-- vim.o.clipboard = "unnamedplus" # sync clipboard b/w os and neovim
