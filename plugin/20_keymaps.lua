...
nmap_leader("bu", "<Cmd>lua MiniBufremove.unshow_in_window()<CR>", "Unshow")
nmap_leader("bU", "<Cmd>lua MiniBufremove.unshow()<CR>", "Unshow!") -- unshow in all windows
nmap_leader("bs", new_scratch_buffer, "Scratch")

-- w is for 'Window'. Common usage:
-- - `<C-w>...` - all window actions start(default mappings)
-- - `<Leader>ws` - split vertically
-- - `<Leader>w=` - equalize splits
-- - `<Leader>wx` - swap splits
nmap_leader("ws", "<C-w>v", "Split(Vert)")
nmap_leader("wS", "<C-w>s", "Split")
nmap_leader("w=", "<C-w>=", "Equalize Splits")
nmap_leader("wx", "<C-w>x", "Exchange(swap) Splits")
nmap_leader("wc", "<C-w>q", "Close")
...
nmap_leader("fh", "<Cmd>Pick help default_split='vertical'<CR>", "Help tags")
...
-- t is for 'Terminal'
-- See:
-- - `:h terminal-input` (https://vi.stackexchange.com/questions/16189/how-to-switch-between-buffer-and-terminal)
-- -  Alternatively, map (mode = 't', lhs = '<C-[hjkl]>', rhs = '<cmd>wincmd [hjkl]<CR>') (four combos)
